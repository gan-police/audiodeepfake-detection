...
python -m src.eval_models \
    ...
    --model-path-prefix ./exp/log3/models/fake_packetsdb8_none_100_22050_22050_256_1-11025_0.7_0.0001_0.01_128_2_10e_lcnn_signsTrue_augcFalse_augnFalse_power1.0 \
    --model "lcnn"  \
    --batch-size 128 \
    --wavelet db8 \
    --f-min 1 \
